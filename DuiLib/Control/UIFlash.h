...
#import "PROGID:ShockwaveFlash.ShockwaveFlash"  raw_interfaces_only, named_guids, rename("IDispatchEx", "IMyDispatchEx"), rename("ICanHandleException", "IMyCanHandleException")
