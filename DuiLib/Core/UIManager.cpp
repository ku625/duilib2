    ...
    case WM_MOUSELEAVE:
        {
			...
			if(m_bMouseTracking)
			{
				//最小化触发的WM_MOUSELEAVE不调用WM_MOUSEMOVE,所以有上面的UIEVENT_MOUSELEAVE
...
LPBYTE CPaintManagerUI::GetBmpBackgroundBits()
{
